...
setup(
    ...
    data_files=[
        ...
        (os.path.join('lib', package_name), ['scripts/so101_motor_bridge', 'scripts/so101_calibrate']),
        ('share/ament_index/resource_index/executables', ['resource/so101_motor_bridge', 'resource/so101_calibrate']),
    ],
